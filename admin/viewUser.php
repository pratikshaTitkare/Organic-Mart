            ...
            <table class="table table-borderd" align="center">
                ...
                <?php
                  ...
                  while($a=mysqli_fetch_array($rs))
                  {
                    extract($a);
                    echo "<tr>";
                    echo "<td>$name</td><td>$address</td><td>$email</td><td>$phone</td><td>$username</td><td>$password</td>";
                    echo"</tr>";
                  }
                  mysqli_close($cn);
                ?>
