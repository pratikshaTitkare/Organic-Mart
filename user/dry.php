...
<?php
 ...
 $query="SELECT * from product where product_category = 'dryfruit' ";
           ...
           <sction class="catehogy" id="category">
            ...
            <div class="row">
                 ...
                 while($row=mysqli_fetch_assoc($result)){
                    ...
                    <center><a href='buy.php?product_id=$product_id&product_name=$product_name&price=$price' id=buy class='btn '>Buy Now</a></center><br>";
